...
public class EditPersonDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater) {
        ...
        Person person = Person.getWorkerByID(personToEditID);
    ...
    public interface EditPersonListener {
        public void editPerson(String name, String phone, String email, Roles.PersonRoles role, int personID);
    }
    //

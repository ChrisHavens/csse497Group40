 ...
 */
        ...
        import edu.rose_hulman.srproject.humanitarianapp.controllers.HttpUtils;
...
public class GitkitDemo extends Activity implements OnClickListener {
    ...
    private UiManager uiManager=new CustomUIManager(this);
...
@Override
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.sign_in) {
            //GitkitUser.UserProfile profile=new GitkitUser.UserProfile(null, null, null, null);
            //client.startSignIn();
            uiManager.showPasswordSignIn("");

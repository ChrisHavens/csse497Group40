...
public class ChecklistREST {
	...
	public Response updateChecklist(@PathParam("id") String id, String json){
		if (!isSame(id, json)){
	...
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response searchChecklist(String json){
	...
	@PUT @Path("{id}")
	@Consumes(MediaType.APPLICATION_JSON)
	public Response addChecklist(@PathParam("id") String id, String json){
	...
	@DELETE @Path("{id}")
	public Response deleteChecklist(@PathParam("id") String id){

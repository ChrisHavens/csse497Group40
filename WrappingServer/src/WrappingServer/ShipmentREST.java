...
public class ShipmentREST {
	...
	public Response updateShipment(@PathParam("id") String id, String json){
		if (!isSame(id, json)){
	...
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response searchShipment(String json){
	...
	@PUT @Path("{id}")
	@Consumes(MediaType.APPLICATION_JSON)
	public Response addShipment(@PathParam("id") String id, String json){
	...
	@DELETE @Path("{id}")
	public Response deleteShipment(@PathParam("id") String id){

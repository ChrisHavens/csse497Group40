...
public class CreateMapping4 {
    ...
    public static void main(String[] args){
        ...
        XContentBuilder personLocation=getMappingPersonLocation();
        ...
        PutMappingResponse putMappingResponse8 = client.admin().indices()
                ...
                .setSource(login)
                .execute().actionGet();
        PutMappingResponse putMappingResponse12 = client.admin().indices()
                .preparePutMapping(INDEXNAME)
                .setType("checkin")
                .setSource(personLocation)
                .execute().actionGet();
...
//    .endObject()
//    .endObject()
    public static XContentBuilder getMappingPersonLocation(){
        try {
            XContentBuilder mapping = org.elasticsearch.common.xcontent.XContentFactory.jsonBuilder()
                    .startObject()
                        .startObject("checkin")
                            .startObject("_parent").field("type", "person").endObject()
                            .startObject("properties")
